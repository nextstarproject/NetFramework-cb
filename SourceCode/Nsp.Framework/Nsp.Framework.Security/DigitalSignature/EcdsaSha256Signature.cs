...
public class EcdsaSha256Signature : EcDsaProvider, IEcdsaShaSignature
{
    ...
    public EcdsaSha256Signature(ECParameters ecParameters) : base(ecParameters)
    {
    }

    public EcdsaSha256Signature(string base64PrivateKey, string base64PublicKey) : base(base64PrivateKey,
        base64PublicKey)
    {
    }
