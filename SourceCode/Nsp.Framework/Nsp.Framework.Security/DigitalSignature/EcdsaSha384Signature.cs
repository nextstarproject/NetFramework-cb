...
public class EcdsaSha384Signature : EcDsaProvider, IEcdsaShaSignature, ISigningCredentialsAlgorithm
{
    public HashAlgorithmName HashAlgorithmNameSetting => HashAlgorithmName.SHA384;
    public string SecurityAlgorithm => SecurityAlgorithms.EcdsaSha384;
    
    public EcdsaSha384Signature() : base(ECCurve.NamedCurves.nistP384)
    {
    }

    public EcdsaSha384Signature(ECParameters ecParameters) : base(ecParameters)
    {
    }

    public EcdsaSha384Signature(string base64PrivateKey, string base64PublicKey) : base(base64PrivateKey,
        base64PublicKey)
    {
    }
