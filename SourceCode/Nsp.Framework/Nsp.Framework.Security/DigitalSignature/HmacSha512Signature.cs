...
/// </summary>
public class HmacSha512Signature : HmacSha512, IHmacShaSignatureAlgorithm
{
    public HmacSha512Signature(byte[] key) : base(key)
    {
    }
    ...
    public HmacSha512Signature(string key) : base(key)
    {
    }
