...
public class RsaSha256Signature : RsaProvider, IRsaShaSignatureAlgorithm, ISignatureX509Algorithm, ISigningCredentialsAlgorithm
{
    ...
    public RsaSha256Signature(int size = 2048) : base(size)
    {
    }

    public RsaSha256Signature(string xmlPrivateAndPublic) : base(xmlPrivateAndPublic)
    {
    }
    
    public RsaSha256Signature(RSAParameters rsaParameters) : base(rsaParameters)
    {
    }
    ...
    public RsaSha256Signature(byte[] pfxData, string? password = "") : base(pfxData, password)
    {
    }
