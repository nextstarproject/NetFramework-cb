...
public class RsaSha384Signature : RsaProvider, IRsaShaSignatureAlgorithm, ISignatureX509Algorithm, ISigningCredentialsAlgorithm
{
    ...
    public RsaSha384Signature(string xmlPrivateAndPublic) : base(xmlPrivateAndPublic)
    {
    }
    
    public RsaSha384Signature(RSAParameters rsaParameters) : base(rsaParameters)
    {
    }
    
    public RsaSha384Signature(X509Certificate2 certificate) : base(certificate)
    {
    }
    
    public RsaSha384Signature(byte[] pfxData, string? password = "") : base(pfxData, password)
    {
    }

    public RsaSha384Signature(string base64PrivateKey, string base64PublicKey) : base(base64PrivateKey, base64PublicKey)
    {
    }
