...
internal class VerificationWindow
{
    ...
    /// </summary>
    public static VerificationWindow RfcSpecifiedNetworkDelay = new VerificationWindow(previous: 1, future: 1);

    public static VerificationWindow ZeroWindow = new VerificationWindow();
}