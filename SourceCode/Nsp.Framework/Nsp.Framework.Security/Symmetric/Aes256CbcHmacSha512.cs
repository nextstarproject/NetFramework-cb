...
public class Aes256CbcHmacSha512 : IAesCbcHmacSha
{
    public static int KeyBitSize => 256;
    public static int KeyByteSize => KeyBitSize / 8;
    public static int HmacKeyBitSize => 512;
    ...
    public Aes256CbcHmacSha512(byte[] key)
    {
    ...
    public Aes256CbcHmacSha512(byte[] aesKey, byte[] hmacKey)
    {
    ...
    public Aes256CbcHmacSha512(string aesKeyBase64)
    {
    ...
    public Aes256CbcHmacSha512(string aesKeyBase64, string hmacKeyBase64)
    {
        var aesKeyBytes = Convert.FromBase64String(aesKeyBase64);
        SecurityInvalidKeyException.ThrowIfInsufficient(aesKeyBytes, KeyByteSize);
        _aesKey = aesKeyBytes;
